  ...
  return (
    <div className=" flex flex-col items-center px-4 py-12">
      <div className="max-w-3xl w-full text-center">
        ...
        <form className=" shadow-xl rounded-3xl p-8 space-y-6 text-left">
          ...
          <div>
            ...
            <textarea
              ...
              rows="5"
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400 resize-none"></textarea>
          </div>
        ...
        <div className="mt-10 ">
          <p>📍 123 IndieVibe Lane, Jaipur, India</p>
          <p>📞 +91 98765 43210</p>
          <p>📧 support@indievibe.com</p>
        </div>
      </div>
    </div>
  );
